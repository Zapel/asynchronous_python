...
if __name__ == '__main__':
    ...
    settlement_priority_list = [{'settlement_hour': datetime.time(14, 0), 'name': u'common'}, {'settlement_hour': datetime.time(8, 0), 'name': u'priority'}, {'settlement_hour': datetime.time(14, 30), 'name': u'urgent'}]


    payoutdate = set_payoutdate(datetime.datetime.today(), 1, 'daily', pay_way='bank_account', spec_day=spec_days, spec_settlement=settlement_priority_list, settlement_priority='urgent')
